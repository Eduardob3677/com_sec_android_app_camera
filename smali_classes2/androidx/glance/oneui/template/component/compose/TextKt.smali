...
.method public static final ComposeAutoText-2T94tj4(Landroidx/compose/ui/Modifier;Landroidx/glance/oneui/template/TextData;Landroidx/glance/text/TextPercentData;ILandroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v2, "androidx.glance.oneui.template.component.compose.ComposeAutoText (Text.kt:53)"
    ...
    invoke-static/range {v14 .. v24}, Landroidx/glance/appwidget/util/FontUtils;->autoTextSizeByDp-HbfmOzc$default(Landroidx/glance/appwidget/util/FontUtils;Landroid/content/Context;Ljava/lang/String;FFFFLandroidx/glance/text/FontFamily;IILjava/lang/Object;)F
    ...
    invoke-interface {v0, v11}, Landroidx/compose/runtime/ScopeUpdateScope;->updateScope(LJ3/n;)V
...
.method public static final ComposeText(Landroidx/glance/oneui/template/TextData;Landroidx/glance/oneui/template/layout/TextSize;Landroidx/glance/unit/ColorProvider;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v2, "androidx.glance.oneui.template.component.compose.ComposeText (Text.kt:171)"
...
.method public static final ComposeText-2T94tj4(Landroidx/compose/ui/Modifier;Landroidx/glance/oneui/template/TextData;Landroidx/glance/text/TextPercentData;ILandroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v2, "androidx.glance.oneui.template.component.compose.ComposeText (Text.kt:85)"
    ...
    sget-object v9, Landroidx/glance/appwidget/util/FontUtils;->INSTANCE:Landroidx/glance/appwidget/util/FontUtils;
    ...
    invoke-static/range {v9 .. v19}, Landroidx/glance/appwidget/util/FontUtils;->autoTextSizeByDp-HbfmOzc$default(Landroidx/glance/appwidget/util/FontUtils;Landroid/content/Context;Ljava/lang/String;FFFFLandroidx/glance/text/FontFamily;IILjava/lang/Object;)F
    ...
    invoke-direct/range {v9 .. v16}, Landroidx/glance/oneui/template/layout/TextSize;-><init>(FLandroidx/glance/text/ComplexUnit;IFLandroidx/glance/text/TextPercentData;ILkotlin/jvm/internal/h;)V
    ...
    new-instance v9, Landroidx/glance/oneui/template/component/compose/TextKt$ComposeText$1;
    ...
    invoke-interface {v0, v9}, Landroidx/compose/runtime/ScopeUpdateScope;->updateScope(LJ3/n;)V
...
.method public static final ComposeText-4QGO3ko(Landroidx/glance/oneui/template/TextData;ILandroidx/glance/text/ComplexUnit;ILandroidx/glance/unit/ColorProvider;Landroidx/compose/ui/Modifier;FLandroidx/compose/runtime/Composer;II)V
    ...
    const-string v2, "androidx.glance.oneui.template.component.compose.ComposeText (Text.kt:156)"
...
.method public static final ComposeText-FbLeKfk(Landroidx/glance/oneui/template/TextData;FILandroidx/glance/unit/ColorProvider;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v7, "androidx.glance.oneui.template.component.compose.ComposeText (Text.kt:121)"
...
.method public static final ComposeText-KuOwvYU(Landroidx/glance/oneui/template/TextData;JILandroidx/glance/unit/ColorProvider;Landroidx/compose/ui/Modifier;FLandroidx/compose/runtime/Composer;II)V
    ...
    const-string v2, "androidx.glance.oneui.template.component.compose.ComposeText (Text.kt:138)"
...
.method public static final ComposeTextList(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;ZLandroidx/compose/runtime/Composer;II)V
    ...
    const-string v3, "androidx.glance.oneui.template.component.compose.ComposeTextList (Text.kt:187)"
    ...
    invoke-interface {v0, v13}, Landroidx/compose/runtime/ScopeUpdateScope;->updateScope(LJ3/n;)V
...
.method private static final update-g2O1Hgs(Landroid/widget/TextView;Landroidx/glance/oneui/template/TextData;Landroidx/glance/oneui/template/layout/TextSize;J)V
    ...
    sget-object p4, Landroidx/glance/text/ComplexUnit;->DP:Landroidx/glance/text/ComplexUnit;
    ...
    sget-object p4, Landroidx/glance/text/TextDirection;->Companion:Landroidx/glance/text/TextDirection$Companion;

    invoke-virtual {p4}, Landroidx/glance/text/TextDirection$Companion;->getDefaultTextDirection-yyWj0Bs()I

    move-result p4

    invoke-static {p3, p4}, Landroidx/glance/text/TextDirection;->equals-impl0(II)Z
    ...
    sget-object p4, Landroidx/glance/text/FontWeight;->Companion:Landroidx/glance/text/FontWeight$Companion;

    invoke-virtual {p4}, Landroidx/glance/text/FontWeight$Companion;->getNormal-WjrlUT0()I

    move-result v1

    invoke-static {p3, v1}, Landroidx/glance/text/FontWeight;->equals-impl0(II)Z
    ...
    :cond_a
    invoke-virtual {p4}, Landroidx/glance/text/FontWeight$Companion;->getSemiBold-WjrlUT0()I
    ...
    :cond_b
    invoke-virtual {p4}, Landroidx/glance/text/FontWeight$Companion;->getBold-WjrlUT0()I

    move-result p4

    invoke-static {p3, p4}, Landroidx/glance/text/FontWeight;->equals-impl0(II)Z
    ...
    invoke-static {v4, v3}, Landroidx/glance/text/TextDecoration;->equals-impl0(II)Z
    ...
    invoke-static {p3, v2}, Landroidx/glance/text/TextDecoration;->equals-impl0(II)Z
    ...
    invoke-virtual {v2}, Landroidx/glance/text/TextShadowStyle;->getDx()F
    ...
    invoke-virtual {v3}, Landroidx/glance/text/TextShadowStyle;->getDy()F
    ...
    invoke-virtual {v4}, Landroidx/glance/text/TextShadowStyle;->getColor-0d7_KjU()J
    ...
    invoke-virtual {p0, p3, v2, v3, v4}, Landroid/widget/TextView;->setShadowLayer(FFFI)V
    ...
    invoke-virtual {p3}, Landroidx/glance/text/TextCategory;->getMinSize()F
    ...
    :cond_12
    invoke-virtual {p2}, Landroidx/glance/text/TextPercentData;->getMinSize()F
    ...
    invoke-virtual {v2}, Landroidx/glance/text/TextCategory;->getMaxSize()F
    ...
    invoke-static {v2, p3}, Landroidx/glance/appwidget/util/FontUtilsKt;->dpToPx-3ABfNKs(Landroid/content/Context;F)I
    ...
    invoke-static {v2, p2}, Landroidx/glance/appwidget/util/FontUtilsKt;->dpToPx-3ABfNKs(Landroid/content/Context;F)I

    move-result p2

    invoke-virtual {p0, p3, p2, v0, v1}, Landroid/widget/TextView;->setAutoSizeTextTypeUniformWithConfiguration(IIII)V
